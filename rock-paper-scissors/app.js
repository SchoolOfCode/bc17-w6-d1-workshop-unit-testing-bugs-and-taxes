...
export function calculateRoundResult(playerMove, computerMove) {
    ...
    if (ROCK === playerMove && PAPER === computerMove) {
        return {
            outcome: LOSS,
            message: "Player chose rock and computer chose paper. Computer wins.",
        };
    ...
    if (playerMove === "Paper" && computerMove === SCISSORS) {
        return {
            outcome: LOSS,
            message:
                "Player chose paper and computer chose scissors. Computer wins.",
        };
    }
    if (playerMove === SCISSORS && computerMove === ROCK) {
        return {
            outcome: LOSS,
            message:
                "Player chose scissors and computer chose rock. Computer wins.",
        };
    }
